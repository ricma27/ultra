...
module.exports = function sonosPlayMP3(mainSonosDevice, secondSonosDevice, fileName, volume){
	return new Promise(function(resolve, reject){
		if(shareSonos.newTrackState === 1) // previous new track not yet loaded
    		...
    		.then(function(){
				if(shareSonos.newTrackState === 2){ // = not sonosPlayMp3 function was launched once again
    				...
    				gladys.modules.sonos.music.removeTrackFromQueue({trackNumber : newTrackPosition, deviceType : {device : mainSonosDevice}})
			    	.then(function(){
