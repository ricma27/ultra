...
module.exports = function sonosGoogleSpeak(mainSonosDevice, secondSonosDevice, language, text, volume){
	return new Promise(function(resolve, reject){
		download(language, text)
		.then(function(fileName){
			return sonosPlayMP3(mainSonosDevice, secondSonosDevice, fileName, volume);
		})
		.then(() => resolve(1));
	});
