	...
	return new Promise(function(resolve, reject){
		...
		.then((devicesType) => {
    		...
    		if((params.brightnessStart > params.brightnessEnd) && params.delay > 0){
				console.log('Regressive brightness hue device : ' + params.device + ', start brightness : ' + params.brightnessStart + ', end brightness : ' + params.brightnessEnd + ', delay in seconds : ' + params.delay);
