	...
	return new Promise(function(resolve, reject){
		...
		.then((devicesType) => {
    		...
    		if((params.brightnessEnd > params.brightnessStart) && params.delay > 0){
				console.log('Progressive brightness hue device : ' + devicesType.binary + ', start brightness : ' + params.brightnessStart + ', end brightness : ' + params.brightnessEnd + ', delay in seconds : ' + params.delay);
        		loopBrightness();
    		}
